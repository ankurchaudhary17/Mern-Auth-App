...
const EmailVerificationPage = () => {
  ...
  //keep track of input references
  ...
  const handleChange = (index, value) => {
    const newCode = [...code]; // this is use to create a shallow copy of the array code
  ...
  const handleKeyDown = (index, e) => {
    //when e.key===backspace and some input intered so it should focus into the previous input ref
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="flex justify-between">
            {/* we map throug this state which is six different element */}
